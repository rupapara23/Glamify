        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {existingImages.map((src, i) => (
                      <div key={i} className="relative">
                        <img
                          src={`http://localhost:5000${src}`} alt=""
              ...
              {/* Upload New */}
              <label className="flex flex-col items-center justify-center w-full h-28 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-indigo-300 hover:bg-indigo-50/30 transition">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="24" height="24" className="text-gray-300 mb-1">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
                <p className="text-sm text-gray-400">Click to upload new images</p>
                <p className="text-xs text-gray-300 mt-0.5">JPG, PNG, WEBP up to 5MB</p>
                <input
